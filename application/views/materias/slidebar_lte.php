      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          ?>
            <li class="header">COMPLEMENTOS ACADEMICOS</li>
...
<!--                <li> 
                ...
                -->
                <li> 
                    <a href="<?= base_url('materias/materia/get_crud') ?>"><i class="glyphicon glyphicon-hand-up"></i>Configuracion Complementos Academicos</a> 
                </li>
