      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          ?>
            <li class="header">PERIODOS ACADEMICOS</li>
...
<!--                <li> 
                ...
                -->
                <li> 
                    <a href="<?= base_url('periodosacad/periodosacade/get_crud') ?>"><i class="glyphicon glyphicon-hand-up"></i>Configuracion Periodo Academicos</a> 
                </li>
